...
export const PostCard: FunctionComponent<PostCardProps> = (
  ...
  <div
    ...
    <div
      ...
      <h3
        className="sm:text-3xl text-2xl font-medium title-font mb-2 text-ebonyclay bg-sundance p-2 inline-block transform ">
        Nitro Enclaves What is attestation all about?
      </h3>
      <div className="flex pt-2 flex-wrap justify-between items-end">
        <h4
          className="sm:text-3xl text-2xl font-medium mb-2 text-ebonyclay transform -rotate-2 pl-2">AWS</h4>
        <h5 className="transform ">March 18th</h5>
      </div>
