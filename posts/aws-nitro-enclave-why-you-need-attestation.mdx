---
title: Why you need attestation
topic: AWS Nitro Enclave
description: Attestation is a feature available to Nitro Enclaves. The enclave uses the attestation process to prove its identity and build trust with an external service.
date: '2021-03-20'
