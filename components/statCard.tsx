...
export const StatCard: FunctionComponent<StatCardProps> = ({
  ...
  >
    <FontAwesomeIcon
      className="text-equator transform -rotate-12 -mt-3 -ml-3 -mb-4 inline"
      width="48"
      icon={icon}
    />

    <blockquote cite={`${credit}`}>
      <h4 className="text-xl lg:text-2xl bg-ebonyclay p-4 text-sundance font-bold mb-2 mt-0">
        <span className="text-hippiegreen">{stat}</span>
        {' '}
        {text}
      </h4>
    </blockquote>
