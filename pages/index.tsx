    ...
    <Layout>
      ...
      <Header>
       ...
       <section>
        ...
        <div className="mt-10 flex bg-rollingstone xl:p-6 rounded inline-flex flex-wrap xl:flex-nowrap justify-center">
          ...
          >
            <h3 className="text-2xl lg:text-4xl bg-sundance mt-4 mx-4 p-4 text-ebonyclay font-bold mt-0">
              Securing the future of digital services.
            </h3>
        ...
        >
          <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
          On a project-by-project basis, we employ the appropriate agile technique.
          </p>
          <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl"> Every implementation will be customised to meet the requirements of the current project. We take pleasure in forming highly effective teams and making sure that teamwork is at the heart of all work done.</p>
        </ServiceCard>
          <ServiceCard
          title="Cloud native solutions."
        >
          <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
            By default, our products use a cloud-native strategy.
          </p>
          <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
             As a result, we can provide dependability, scalability, and high performance while reducing the time to market. Where appropriate, we choose serverless functions, managed services, and containers. 
        ...
        >
          <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
            Getting architecture right can be tricky. 
           </p>
           <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
            By offering advice and collaborating closely with your team to ensure that the ideal solution is architected, we can assist with this. It's critical for us to fully comprehend your challenges and how we might help in their resolution.
           </p>
        </ServiceCard>
          </details>
           <details className='details_home lg:p-8' open>
        ...
        >
          <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
Allow Mozstro to manage the cloud infrastructure for your company while guiding you through it. 
           </p>
           <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
            We deliver consistent, highly scalable cloud solutions from cloud native experts. Even better, our migration services make it simple for your company's systems to migrate to the cloud.
           </p>
        </ServiceCard>
         <ServiceCard
        ...
        >
          <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
            Within the Cloud, external risks are more common than ever. 
             </p>
             <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
              We believe it is essential to ensure that you are in the capable hands of professional consultants who will protect your position in the cloud by following best practises. You and your company will benefit from the piece of mind that comes with safeguarding your data, infrastructure, and code integrity.
             </p>
        </ServiceCard>
         <ServiceCard
        ...
        >
          <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
          Having a strong team of Full stack engineers is vital within the cloud.
           </p>
           <p className="font-serif text-sundance bg-ebonyclay shadow px-4 pt-4 pb-2 lg:px-6 text-md lg:text-xl">
      ...
      <section>
         <div className="flex mt-16 mb-8 justify-center">
          <SectionText text="Lets deliver value faster." />
        </div>
