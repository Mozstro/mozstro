...
import { serviceFilePaths, SERVICES_PATH } from '../../lib/mdx';
  ...
  return (
    <Layout customMeta={customMeta}>
      ...
      <div className="mt-4 md:mb-0 md:ml-12 md:mt-16">
        <NavButton text="← Back" link="/services" />
      </div>
      <article>
        <div>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  const serviceFilePath = path.join(SERVICES_PATH, `${params.slug}.mdx`);
  const source = fs.readFileSync(serviceFilePath);
